...
function Footer() {
    return (
    <div className="p-2 sm:p-12 footer">
             {/*Subcribe*/}
      <div className='sm:flex items-center justify-between home-foot mb-10'>
        
        <div className='sm:w-1/2 text-4xl'>Subcribes to Our Newsletter</div>
        ...
        <FontAwesomeIcon className='hover:opacity-0' icon={faEnvelope} />
          ...
          <button className='text-xl cursor-pointer bg-red-600 hover:bg-red-700 py-1.5 px-2 sm:px-5 rounded shadow text-white' type='submit'>Subcribe</button>
        </div>
        </form>
        </div>
      </div>
      ...
      <div className="flex justify-between mt-2 mb-5">
        <div className='w-2/4 sm:w-2/5 pr-1 sm:pr-8'>
        ...
        <div className="w-1/4 sm:w-1/5 mr-1">
      ...
      <div className="sm:w-1/2 text-xl">Copyright@2023 Topmarktech x Hademathtech</div>
      <div className='sm:w-1/2 flex sm:pl-64 sm:space-x-50'>
